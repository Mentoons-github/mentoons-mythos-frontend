  ...
  return (
    ...
    >
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <h1 className="text-2xl md:text-3xl font-bold text-[#1A1D3B] w-3/4">
          Explore Podcasts For Sports Intelligence
        </h1>
        <img
...
export default ExploreSportsProdcats;
