...
const RashiForm: React.FC<RashiFormProps> = ({
  ...
  return (
    ...
    >
      <h2 className="font-serif font-bold text-3xl bg-gradient-to-r from-gray-700 via-black to-gray-900 bg-clip-text text-transparent mb-2">
        Find Your Rashi
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 text-left">
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label className="block text-gray-800 mb-2">Date of Birth</label>
            <input
              type="date"
              name="dateOfBirth"
              value={formData.dateOfBirth}
              onChange={handleChange}
              className="w-full p-3 bg-black rounded-lg text-white border border-gray-600 focus:border-white/50 transition-colors"
              required
            />
          </div>
          <div>
            <label className="block text-gray-800 mb-2">Time of Birth</label>
            <input
              type="time"
              name="timeOfBirth"
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label className="block text-gray-800 mb-2">Latitude</label>
            <input
              type="text"
              name="latitude"
          ...
          <div>
            <label className="block text-gray-800 mb-2">Longitude</label>
            <input
              type="text"
              name="longitude"
        ...
        <div className="flex space-x-4">
          <motion.button
            ...
            className="flex-1 px-4 py-2 bg-black text-white rounded-lg hover:bg-black/90 transition-colors"
          ...
          <div className="space-y-3">
            ...
            >
              <input
                ...
                className="mr-3 w-4 h-4 text-black bg-gray-700 border-gray-600 focus:ring-white focus:ring-2"
              />
        ...
        <div className="flex space-x-4 pt-4">
          <motion.button
            ...
            className="flex-1 bg-gradient-to-r from-gray-900 via-black to-gray-900 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <motion.button
            type="button"
            onClick={onClose}
            className="px-6 py-3 border border-gray-600 rounded-lg hover:bg-white/80 font-semibold text-black transition-colors"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            Cancel
